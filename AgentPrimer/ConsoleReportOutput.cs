...
internal sealed class ConsoleReportOutput
{
    ...
    public int WriteReport(PrimerReport report)
    {
        ...
        if (m_agentMode)
        {
            sb.AppendLine("# Agents.md — Guidance for AI-assisted Development");
            ...
            sb.AppendLine("## Summary for Agents");
            sb.AppendLine("Use this overview as factual context when generating or editing code.  ");
            sb.AppendLine("Avoid unnecessary token use; prefer referencing this document instead of re-parsing source files.");
        }
        else
        {
        ...
        {
            "Match the project’s English style for identifiers, comments, and documentation."
        };
